    ...
    function fetchDataFromBrowserQueryAndUpdateUI() {
        ...
        */
        ...
        if (mainIndic == 0) {
            if(hod == 1){
                citiesTableID = '1agGkJd2Qpu9gWzVV8EHe_0SWkwYvm_3-jst_cIPe';
                titleText = "DMA Overall - All ULB Indicators";
                unitOfIndicator = "-";
            }else if(hod == 2){
                citiesTableID = '12OdrJntgd9cCZuiY5bxyLs-MPBBq8PpNoM14Ga53';
                titleText = "CE Overall - All ULB Indicators";
                unitOfIndicator = "-";
            }else if(hod == 7){
                citiesTableID = '1CrvnjPfFm3Y-SupXQLQePvutSINhETMT5cwLqQXK';
                titleText = "Combined - All ULB Indicators";
                unitOfIndicator = "-";
            }
        }else if (mainIndic == 1) {
            if (subMainIndic == 0) {
                citiesTableID = '1mXfgDCxwwAuRq8rzSwKD9hRsGPBJyDNQSbBX_MXw';
                titleText = "Swachcha Andhra - Overall";
                unitOfIndicator = "-";
            }else if (subMainIndic == 1) {
                citiesTableID = '1GjlW8rFv6-3ZNb2VY-L9MPWBw_cajzhjESCPeAHt'; 
                titleText = "Swachcha Andhra - Individual Household Toilets (IHT) coverage";
                unitOfIndicator = "No. of Toilets";
            }else if (subMainIndic == 2) {
                citiesTableID = '1gNcbpR8PL7e___KBnbJBqbHEwP4M2ICzYI9OhU99'; 
                titleText = "Swachcha Andhra - Community Toilets coverage";
                unitOfIndicator = "No. of Toilets";
            }
        }else if (mainIndic == 2) {
            if (subMainIndic == 0) {
                citiesTableID = '1Cb5Jbbm_4xoPYARP4tGnwo4ltBQFUBXdp8DXhYaq';
                titleText = "Greenery - Tree Plantation";
                unitOfIndicator = "No. of plantations";
            }
        }else if (mainIndic == 3) {
            if (subMainIndic == 0) {
                citiesTableID = '1D-ZPhlcNiyw0NvyTiPrIO4c_0Z2_PGfh_t2fIiMp';
                titleText = "Solid Waste Management - Overall";
                unitOfIndicator = "-";
            } else if (subMainIndic == 1) {
                citiesTableID = '1mOvAxEu1yJgEpJeD42zqW0Ug6RovszFYyNEyz9sW'; 
                titleText = "Solid Waste Management - Door to Door Garbage Collection";
                unitOfIndicator = "No. of Households";
            } else if (subMainIndic == 2) {
                citiesTableID = '1gzbsHXWQAg2FjLUf5yIn9o4lSteOCcCfbZv2fgFZ'; 
                titleText = "Solid Waste Management - Garbage Lifting";
                unitOfIndicator = "Metric tonnes";
            }
        }else if (mainIndic == 4) {
            if (subMainIndic == 0) {
                citiesTableID = '1sZqS5hEhYtYIBNCoq9Qm1KrLxSREUcGOFv3JAvPF';
                titleText = "Property Tax - Overall";
                unitOfIndicator = "-";
            } else if (subMainIndic == 1) {
                citiesTableID = '1GZMN7krK4zbjt9yQy444Zqehdta4sx0ikI2Eot7S'; 
                titleText = "Property Tax -  Collection Efficiency";
                unitOfIndicator = "Rupees (in lakhs)";
            } else if (subMainIndic == 2) {
                citiesTableID = '1bzYGXPZo1HxIAkYDfWvCx_VcHLcXROjW7RgeqS_J'; 
                titleText = "Property Tax  - Demand Increase";
                unitOfIndicator = "Rupees (in lakhs)";
            }
        }else if (mainIndic == 5) {
            if (subMainIndic == 0) {
                citiesTableID = '1M-8-rUSv6Y8bzpRt_KZw0MlRFZTeIy871gotdjd9';
                titleText = "Citizen Services - Overall";
                unitOfIndicator = "-";
            } else if (subMainIndic == 1) {
                citiesTableID = '1PvVqy0LunFO-AfLI2bEFPM6R7kAgquoDAbdw6gze'; 
                titleText = "Citizen Services - Citizen Charter (office)";
                unitOfIndicator = "No. of applications";
            } else if (subMainIndic == 2) {
                citiesTableID = '1MpcqP6H9A8rF2M4qgg51XaYGIuAvuUdY3DDBFzBY'; 
                titleText = "Citizen Services - Grievances Redressal (field)";
                unitOfIndicator = "No. of grievances";
            }
        }else if (mainIndic == 6) {
            if (subMainIndic == 0) {
                citiesTableID = '1Fw67e-DYpXZ5IR3AnwyzmQkjfw0grS5PX2IUmhJN';
                titleText = "Finance - Overall";
                unitOfIndicator = "-";
            } else if (subMainIndic == 1) {
                citiesTableID = '1ETn0t161YIbAgqhRraKu2s_0Cko8JYKm6gPdOf_R'; 
                titleText = "Finance - Double Entry Accounting";
                unitOfIndicator = "No. of days";
            } else if (subMainIndic == 2) {
                citiesTableID = '1DB0lUXUgwvAmy3CvFEMhKeMKSLsPAuL4igQo3RoV';
                titleText = "Finance - Pending Accounts and Audit";
                unitOfIndicator = "No. of years";
            }
        }else if (mainIndic == 7) {
            citiesTableID = '1yUMCthVrsczEsgBQ8rWURXhrL8W0Ptr--3IlztZl';
            titleText = "Education - High schools with IIT foundation";
            unitOfIndicator = "No. of High schools";
        }else if (mainIndic == 8) {
            if (subMainIndic == 0) {
                citiesTableID = '1CN_RRUGLwL-U6UoUf7Wo5JfnS7PGbDzhKlc_xb8P';
                titleText = "Water Supply Connections - Overall Coverage";
                unitOfIndicator = "-";
            } else if (subMainIndic == 1) {
                citiesTableID = '1BZsv-ktkAAEHbCherHKki1_5_n8sU4w1-PIVJVmt'; 
                titleText = "Water Supply - Connections Coverage";
                unitOfIndicator = "No. of Connections";
            } else if (subMainIndic == 2) {
                citiesTableID = '10sEB7Cf5Bhk33G356KYcxijkOqlhWguUvy6BGVaW'; 
                titleText = "Water Supply per month - Cost Recovery";
                unitOfIndicator = "Rupees (in Lakhs)";
            }
        }else if (mainIndic == 9) {
            if (subMainIndic == 0) {
                citiesTableID = '1ZlA9EGzZp8jkDR8n6U3qiQlyqa6oOihUSLA_OgnW';
                titleText = "Street Lighting - Overall";
                unitOfIndicator = "-";
            } else if (subMainIndic == 1) {
                citiesTableID = '109xaJRVwtAg9nbm-KoeoOIOSZO9rzF-aN3tfXzr4'; 
                titleText = "Street Lighting - LED Coverage";
                unitOfIndicator = "No. of LEDs";
            } else if (subMainIndic == 2) {
                citiesTableID = '1j9snnA5PW81FknNK4JSejL55t-6W16ecelZNYzgY';
                titleText = "Street Lighting - Additional Fixtures";
                unitOfIndicator = "No. of Fixtures";
            }
        }else if (mainIndic == 11) {
            if (subMainIndic == 0) {
                citiesTableID = '1uDJfvIBlalMZf--C5JMJpjp-115FRBiYQZF-cOAb'; 
                titleText = "Town Planning Activities - Building Online Permissions";
                unitOfIndicator = "No.of Applications";
            }
        }else if (mainIndic == 12) {
            if (subMainIndic == 0) {
                citiesTableID = '1JBJG8XhJc0Oiu89BLWmjnxrHP5lXQanB-xjP4wqJ';
                titleText = "Community Development - Overall";
                unitOfIndicator = "-";
            } else if (subMainIndic == 1) {
                citiesTableID = '18axKnLMUDL3Zx8Y7s6TK7_IHn0NZtFpN7psdBxXX'; 
                titleText = "Community Development - SHG Bank Linkage";
                unitOfIndicator = "Rupees (in lakhs)";
            } else if (subMainIndic == 2) {
                citiesTableID = '1-K7baFyvJvoCkmVIG0z4RGP8qctERfb-CwLlCKDs'; 
                titleText = "Community Development - Livelihood";
                unitOfIndicator = "No.";
            }else if (subMainIndic == 3) {
                citiesTableID = '1E-DKdBeT2vp0CIdM8yrgnuh-wRMe7RpWHlKQdY0r'; 
